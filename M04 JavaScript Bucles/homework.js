...
function esPrimo(num) {
 ...
 // Comenzamos a verificar desde 2 hasta la raíz cuadrada del número
...
function tieneTresDigitos(num) {
  ...
  // Verificar si la cadena tiene tres dígitos
  if (numStr.length === 3) {
    return true;
  } else {
    return false;
...
function doWhile(num) {
   ...
   // Tu código:
   let contador = 0; // Inicializamos un contador para llevar un seguimiento de las veces que aumentamos el valor
   do {
     num += 5; // Aumentamos el valor en 5
     contador++; // Incrementamos el contador
   } while (contador < 8); // Continuamos haciendo esto mientras el contador sea menor que 8
